...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        self.parser.add_argument('--nThreads', type=int, default=5, help='# of threads for data loader')

        #ouptput related
        self.parser.add_argument('--name', type=str, default='trial', help='folder name to save outputs')
        self.parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10','stl10'],help='folder name to save outputs')
        self.parser.add_argument('--display_dir', type=str, default='./logs_stl32_div', help='path for saving display results')
        self.parser.add_argument('--result_dir', type=str, default='./results_stl32_div', help='path for saving result images and models')
        self.parser.add_argument('--display_freq', type=int, default=1, help='freq (iteration) of display')
        self.parser.add_argument('--img_save_freq', type=int, default=2, help='freq (epoch) of saving images')
        ...
        self.parser.add_argument('--div', action='store_true', help='whether apply if div')
...
class TestOptions(BaseOptions):
    def __init__(self):
        ...
        self.parser.add_argument('--result_dir', type=str, default='./origin_true_five_big', help='path for saving result images and models')
        self.parser.add_argument('--div', action='store_true', help='whether apply if div')
        # model related
