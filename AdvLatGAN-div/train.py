# CUDA_VISIBLE_DEVICES=3 python train.py --dataroot ./datasets/Cifar10 --result_dir ./msgan
...
def main():
    ...
    if  opts.dataset=='stl10':
        dataset = torchvision.datasets.STL10(opts.dataroot, split='test', download=True, transform= transforms.Compose([
            transforms.Resize(opts.img_size),
            transforms.ToTensor(),
            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]))
    ...
    for ep in tqdm.tqdm(range(ep0, opts.n_ep)):
